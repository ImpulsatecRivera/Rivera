...
router.get('/individual/:id',validateAuthToken(["admin", "Operativo", "Supervisor","Coordinador"]),  ReportesCajaChicaController.generarPDFIndividual);
...
router.get('/todos',validateAuthToken(["admin", "Operativo", "Supervisor","Coordinador"]),  ReportesCajaChicaController.generarPDFTodosMovimientos);
...
router.get('/mensual-simple/:mes/:ano', validateAuthToken(["admin", "Operativo", "Supervisor","Coordinador"]),ReportesCajaChicaController.generarPDFMensualSimple);
...
router.post('/mensual-multiple',validateAuthToken(["admin", "Operativo", "Supervisor","Coordinador"]), ReportesCajaChicaController.generarPDFMultiplesMeses);
...
router.get('/diario/:fecha',validateAuthToken(["admin", "Operativo", "Supervisor","Coordinador"]), ReportesCajaChicaController.generarPDFDiario);
...
router.post('/rango-fechas',validateAuthToken(["admin", "Operativo", "Supervisor","Coordinador"]), ReportesCajaChicaController.generarPDFRangoFechas);
