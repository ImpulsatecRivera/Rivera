...
const SuccessAlert = ({ 
  ...
  const defaultTitle = title || (isEdit 
    ? 'Elemento actualizado con éxito' 
    : 'Elemento eliminado con éxito');
    
  const defaultDescription = description || (isEdit 
        ...
        >
          <div className="text-center">
            ...
            >
              <button
                onClick={onClose}
                className="px-8 py-2 text-white rounded-lg transition-all duration-200 transform hover:scale-105 hover:shadow-lg active:scale-95"
