    ...
    <div className="p-8 pt-4 border-t border-gray-100" style={{backgroundColor: '#f8fafc'}}>
      <div className="flex items-center justify-between">
        <div className="text-sm text-gray-500">
          Mostrando datos {(currentPage - 1) * itemsPerPage + 1} a {Math.min(currentPage * itemsPerPage, filterProveedores.length)} de {filterProveedores.length} entradas
        </div>
