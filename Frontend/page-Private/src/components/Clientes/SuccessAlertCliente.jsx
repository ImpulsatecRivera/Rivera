...
const SuccessAlertCliente = ({ isOpen, onClose, type = 'delete' }) => {
    ...
    <>
      ...
      >
        <div
          ...
          style={{ animation: isOpen ? 'slideInUp 0.4s cubic-bezier(0.34, 1.56, 0.64, 1)' : 'none' }}
        >
          <div className="text-center">
            <div
              ...
              style={{ animation: isOpen ? 'bounceIn 0.6s ease-out 0.2s both' : 'none' }}
            >
            ...
            >
              {isEdit ? 'Cliente actualizado con éxito' : 'Cliente eliminado con éxito'}
            </h3>
            <p
              className="text-gray-600 mb-6 transition-all duration-300"
              style={{ animation: isOpen ? 'fadeInUp 0.5s ease-out 0.4s both' : 'none' }}
            >
              {isEdit ? 'Cliente actualizado correctamente' : 'Cliente eliminado correctamente'}
            </p>
            <div
              className="flex justify-center"
              style={{ animation: isOpen ? 'fadeInUp 0.5s ease-out 0.5s both' : 'none' }}
            >
              <button
                onClick={onClose}
...
export default SuccessAlertCliente;
