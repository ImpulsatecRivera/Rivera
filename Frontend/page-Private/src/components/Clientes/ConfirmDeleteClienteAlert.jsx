...
const ConfirmDeleteClienteAlert = ({ isOpen, onClose, onConfirm, clientName }) => {
      ...
      >
        ...
        >
          <div className="text-center">
            ...
            >
              {clientName ? `${clientName} se eliminará con esta acción` : 'El cliente se eliminará con esta acción'}
            </p>
            <div
...
export default ConfirmDeleteClienteAlert;
