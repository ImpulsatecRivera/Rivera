  ...
  return (
    <div className={`space-y-2 ${className}`}>
      ...
      <textarea
        ...
        rows={rows}
        className={`w-full px-3 sm:px-4 py-2.5 sm:py-3 rounded-lg sm:rounded-xl border-2 transition-all duration-300 focus:outline-none focus:ring-4 resize-none ${
          error
