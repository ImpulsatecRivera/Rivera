...
const DetailPanel = ({ 
  ...
  useEffect(() => {
    // Activar loading cada vez que cambie el motorista seleccionado
    setIsLoading(true);
    ...
    <div className="w-96 bg-white rounded-2xl shadow-2xl relative overflow-hidden flex flex-col h-full">
      ...
      <div className="flex items-center justify-between p-8 pb-4 flex-shrink-0">
        <div className="flex items-center">
          ...
          <h2 className="text-xl font-semibold text-gray-900">Detalles del Motorista</h2>
        </div>
      ...
      <div className="flex-1 overflow-y-auto px-8 pb-8">
        ...
        <div className="text-center mb-10">
          <div className="relative inline-block">
            <div className="w-28 h-28 rounded-2xl mx-auto mb-4 flex items-center justify-center shadow-lg overflow-hidden" style={{background: 'linear-gradient(135deg, #5F8EAD 0%, #4a7ba7 100%)'}}>
              ...
              <User className={`w-14 h-14 text-white ${selectedMotorista.img ? 'hidden' : 'block'}`} />
            </div>
          </div>
          <h3 className="font-bold text-xl mb-2 text-gray-900">{selectedMotorista.name} {selectedMotorista.lastName}</h3>
        ...
        <div className="space-y-6">
          ...
          <div className="bg-gradient-to-r from-blue-50 to-blue-100 rounded-xl p-6 border border-blue-200">
            ...
            <div className="space-y-4">
              <div>
                ...
                <div className="text-sm text-gray-600 break-words bg-white p-3 rounded-lg border">{selectedMotorista.email}</div>
              </div>
              <div>
                <div className="text-sm font-medium text-gray-700 mb-1">DUI</div>
                <div className="text-sm text-gray-600 bg-white p-3 rounded-lg border">{selectedMotorista.id}</div>
              </div>
            </div>
          </div>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                <div className="text-sm text-gray-600 bg-white p-3 rounded-lg border flex items-center">
                  ...
                  {selectedMotorista.phone ? selectedMotorista.phone.toString() : 'No disponible'}
                </div>
              </div>
              <div>
                ...
                <div className="text-sm text-gray-600 bg-white p-3 rounded-lg border flex items-center">
                  ...
                  {selectedMotorista.address || 'No disponible'}
                </div>
              </div>
            </div>
          </div>
          ...
          <div className="bg-gradient-to-r from-gray-50 to-gray-100 rounded-xl p-6 border border-gray-200">
            ...
            <div className="space-y-4">
              <div>
                <div className="text-sm font-medium text-gray-700 mb-1">Tarjeta de Circulación</div>
                <div className="text-sm text-gray-600 bg-white p-3 rounded-lg border flex items-center">
                  <CreditCard className="w-4 h-4 mr-2" style={{color: '#34353A'}} />
                  {selectedMotorista.circulationCard || 'No disponible'}
                </div>
              </div>
              <div>
                <div className="text-sm font-medium text-gray-700 mb-1">Estado de Licencia</div>
