...
const useMotoristaManagement = () => {
  ...
  const fetchMotoristas = async () => {
    try {
      ...
      const response = await axios.get('https://riveraproject-production.up.railway.app/api/motoristas');
  ...
  const confirmDelete = async () => {
    ...
    try {
      await axios.delete(`https://riveraproject-production.up.railway.app/api/motoristas/${selectedMotorista._id || selectedMotorista.id}`);
    ...
    try {
      ...
      if (formData.image) {
        ...
        const fetchResponse = await fetch(
          `https://riveraproject-production.up.railway.app/api/motoristas/${selectedMotorista._id || selectedMotorista.id}`,
          {
            method: 'PUT',
            body: submitData,
