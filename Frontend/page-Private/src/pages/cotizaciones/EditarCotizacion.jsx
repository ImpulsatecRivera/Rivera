...
const Seleccionar = () => {
  ...
  return (
    <div className="relative min-h-screen bg-gradient-to-br from-orange-50 via-white to-purple-50 py-12 px-4 overflow-hidden">
      {/* Lottie Background Pattern - Repetido para cubrir toda la pantalla */}
      <div className="absolute inset-0 pointer-events-none">
        ...
        {/* Centro superior */}
        <div className="absolute top-10 left-1/2 transform -translate-x-1/2 w-48 h-48">
          <Lottie
            animationData={animationData}
            loop={true}
            autoplay={true}
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        <div className="text-center mb-16">
          ...
          <div className="flex justify-center">
            <img src={characterImage} alt="Character" className="w-32 h-auto drop-shadow-lg" />
          </div>
        </div>
