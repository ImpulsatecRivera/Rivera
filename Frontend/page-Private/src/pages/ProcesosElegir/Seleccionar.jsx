...
import animationData from '../../assets/lotties/background lines wave.json';
...
const Seleccionar = () => {
  ...
  return (
    <div className="relative min-h-screen py-12 px-4 overflow-hidden">
      {/* Lottie Background - Más grande y visible */}
      <div className="absolute inset-0 z-0 opacity-30">
        <Lottie 
          ...
          style={{ 
            ...
            height: '100%',
            objectFit: 'cover',
            transform: 'scale(1.5)' // Hace la animación 1.5 veces más grande
          }}
        />
      </div>

      {/* Overlay más sutil para mejor visibilidad del Lottie */}
