...
const AgregarEmpleado = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      console.log('URL:', 'riveraproject-production.up.railway.app/api/empleados');

      // Enviar petición
      const response = await axios.post('riveraproject-production.up.railway.app/api/empleados', formDataToSend, {
        headers: {
