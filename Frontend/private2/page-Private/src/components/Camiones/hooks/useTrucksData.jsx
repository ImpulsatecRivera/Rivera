...
const useTrucksData = () => {
  ...
  const fetchTrucks = async () => {
    try {
      ...
      const response = await fetch('riveraproject-production.up.railway.app/api/camiones', fetchOptions);
  ...
  const deleteTruck = async (truckId) => {
    try {
      ...
      const response = await fetch(`riveraproject-production.up.railway.app/api/camiones/${truckId}`, {
        method: 'DELETE',
        ...fetchOptions,
      });
