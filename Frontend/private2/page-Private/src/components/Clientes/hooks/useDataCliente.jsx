...
const useDataCliente = () => {
  ...
  const fetchClients = async () => {
    try {
      ...
      const response = await axios.get('https://riveraproject-production.up.railway.app/api/clientes');
  ...
  const addClient = async (clientData) => {
    try {
      ...
      const response = await axios.post('https://riveraproject-production.up.railway.app/api/clientes', clientData);
  ...
  const updateClient = async (clientId, updateData) => {
    try {
      ...
      const response = await axios.put(`https://riveraproject-production.up.railway.app/api/clientes/${clientId}`, updateData);
  ...
  const deleteClient = async (clientId) => {
    try {
      ...
      await axios.delete(`https://riveraproject-production.up.railway.app/api/clientes/${clientId}`);
